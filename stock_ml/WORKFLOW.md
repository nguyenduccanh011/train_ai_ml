...
4. [Bố Trí Dữ Liệu](#4-bố-trí-dữ-liệu)
5. [Tham Khảo Config](#5-tham-khảo-config)
6. [Tham Khảo Feature](#6-tham-khảo-feature)
7. [Workflow A: Chạy Backtest Mới](#7-workflow-a-chạy-backtest-mới)
8. [Workflow B: Đăng Ký Vào Leaderboard](#8-workflow-b-đăng-ký-model-vào-leaderboard)
9. [Workflow C: Ghim Lên Dashboard](#9-workflow-c-ghim-model-lên-dashboard)
10. [Workflow D: Retire Model](#10-workflow-d-retire-model)
11. [Workflow E: Chạy Live Simulation](#11-workflow-e-chạy-live-simulation)
12. [Tham Khảo Output Files](#12-tham-khảo-output-files)
13. [Model Lifecycle States](#13-model-lifecycle-states)
14. [Thêm Model Type Mới](#14-thêm-model-type-mới)
...
### 5.1 RunConfig — Tham Số Batch Backtest
...
### 5.2 LiveSimConfig — Tham Số Day-by-Day Simulation
...
## 7. Workflow A: Chạy Backtest Mới
...
## 8. Workflow B: Đăng Ký Model Vào Leaderboard
...
## 9. Workflow C: Ghim Model Lên Dashboard
...
## 11. Workflow E: Chạy Live Simulation
