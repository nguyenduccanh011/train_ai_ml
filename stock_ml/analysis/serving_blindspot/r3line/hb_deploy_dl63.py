...
# ---- 3 variants: nhan dien ro tren leaderboard/danh muc ----
VARIANTS = [
    dict(name="x2_struct_to_k10_cs5ma50_r7ec_gt_dl63aggr", th=0.10, mode="skip", size=1.0,
         tag=("[DL63-AGGR max-CAGR] Champion gtrail + SKIP entry sat day-63-phien (dist_l63<0.10). "
              "Loai lenh chan-song chua breakout de giai phong slot cho lenh chat hon. "
              "3-seed T+2 CAGR ~139% (1-seed dinh ~148%), DD~-16.5% (return cao nhat, DD xau hon). "
              "Lever selection thuan causal, khong retrain.")),
    dict(name="x2_struct_to_k10_cs5ma50_r7ec_gt_dl63bal", th=0.13, mode="skip", size=1.0,
         tag=("[DL63-BAL can-bang] Champion gtrail + SKIP entry dist_l63<0.13. "
              "Diem can bang CAGR va DD: 3-seed T+2 CAGR ~137%, DD~-12.2%, Calmar ~11.2 (base 8.7).")),
    dict(name="x2_struct_to_k10_cs5ma50_r7ec_gt_dl63size", th=0.13, mode="size", size=0.7,
         tag=("[DL63-SIZE best-riskadj KHUYEN NGHI] Champion gtrail + GIU entry dist_l63<0.13 nhung SIZE x0.7 "
              "(giu exposure, giam rui ro). Va under-exposure dead-year 2024 (NAV 69->81%). "
              "3-seed T+2 CAGR ~135.5%, DD~-11.8%, Calmar ~11.5 (best risk-adjusted).")),
]
