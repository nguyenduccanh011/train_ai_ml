...
VARIANTS = {
    "er_nopb":  {"entry_pullback_pct": None},
    "er_pb02":  {"entry_pullback_pct": 0.02},
    "er_fim":   {"entry_pullback_fill_if_missed": True},
    "er_fim02": {"entry_pullback_pct": 0.02, "entry_pullback_fill_if_missed": True},
}
      ...
      async with Session() as s:
        ...
        for nm, ov in VARIANTS.items():
            ...
            t = await repo.create(name=nm, market=base.market, strategy=base.strategy, feature_set_id=base.feature_set_id,
                                  ...
                                  validation_config=base.validation_config, seed=base.seed, description=f"entry-research {ov}",
                                  hypothesis="capture the runaways the 4.5% pullback skips", universe_slug=base.universe_slug, model_mode=base.model_mode)
...
print("\n=== ENTRY-RESEARCH r1 (combo preempt+cs+skip), 3-seed, vs champion ===", flush=True)
base = res["champion"]
