...
for s, g in px.groupby("symbol"):
    ...
    g["ret5"] = c / c.shift(7) - 1  # 7-day momentum window
...
print("=== CROSS-K: ret7-gate dưới T+2, 3-seed (Δ vs no-gate) ===", flush=True)
...
print("\n=== PER-YEAR: K10/cs5_ma50 T+2, seed-mean return theo năm (base vs ret7<0.02) ===", flush=True)
...
for sd in SEEDS:
    ...
    _, _, ng = prun(NavSim2(cv_c[sd], date_lo="2020-01-01"), pm[sd], cms[sd], 10, 0.005, 2.0, r5s[sd], 0.02, want_nav=True)
