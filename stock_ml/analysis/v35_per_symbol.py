...
m = (
    per_sym(v34, "v34")
    .merge(per_sym(v35b, "v35b"), on="symbol", how="outer")
    .merge(per_sym(v35c, "v35c"), on="symbol", how="outer")
    .merge(per_sym(rule, "rule"), on="symbol", how="outer")
    .fillna(0)
)
...
print(
    m_sorted[
        ["symbol", "comp_v34", "comp_v35b", "comp_v35c", "comp_rule", "v35b-v34", "v35b-rule"]
...
print(
    f"Symbols V34 thua Rule -> V35b sua duoc: {((m['comp_v34'] < m['comp_rule']) & (m['comp_v35b'] >= m['comp_rule'])).sum()}"
)
