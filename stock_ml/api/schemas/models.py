...
class ModelInfo(BaseModel):
    ...
    win_rate: float | None = Field(None, ge=0, le=1, description="Win rate 0-1")
    trade_count: int | None = Field(None, ge=0, description="Number of trades")
...
class LeaderboardEntry(BaseModel):
    ...
    max_drawdown: float | None = Field(None, description="Max drawdown percentage")
