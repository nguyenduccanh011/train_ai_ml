...
from src.config_loader import get_training_device, get_pipeline_config
...
def run_test(symbols_str, mod_a, mod_b, mod_c=False, mod_d=False, mod_e=False,
             ...
             backtest_fn=backtest_v19_1, device=None, feature_set="leading_v2"):
    ...
    # Resolve device: explicit param > base.yaml > default "cpu"
    if device is None:
        device = get_training_device()
    resolved_device = detect_device(device)
    print(f"    🖥️  Training device: {resolved_device.upper()}"
