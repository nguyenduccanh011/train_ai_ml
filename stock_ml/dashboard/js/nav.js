(function () {
  const PAGES = [
    ...
    { href: 'universe.html',         label: 'Universes' },
    { href: 'model-library.html',    label: '📚 Model Library' },
    { href: 'template-explorer.html', label: '📋 Templates' },
    { href: 'template-builder.html', label: '🔧 Template Builder' },
