...
y0 = 0.93
ax7.text(
    0.04, y0, "Metric", color="white", fontsize=8.5, fontweight="bold", transform=ax7.transAxes
)
ax7.text(0.44, y0, "Base", color=COL_BASE, fontsize=8.5, fontweight="bold", transform=ax7.transAxes)
ax7.text(
    0.72, y0, "+Model B", color=COL_A, fontsize=8.5, fontweight="bold", transform=ax7.transAxes
)
ax7.plot(
    [0.02, 0.98], [y0 - 0.05, y0 - 0.05], color=COL_GRID, linewidth=0.8, transform=ax7.transAxes
)
...
plt.savefig("results/v42_compare.png", dpi=150, bbox_inches="tight", facecolor=fig.get_facecolor())
