...
if __name__ == "__main__":
    ...
    configs = [
        ...
        (
            "V22-hb8+std6",
            {"v22_fast_exit_threshold_hb": -0.08, "v22_fast_exit_threshold_std": -0.06},
        ),
        (
            "V22-hb8+std6+cap3.5",
            {
                "v22_fast_exit_threshold_hb": -0.08,
                "v22_fast_exit_threshold_std": -0.06,
                "v22_hard_cap_mult_hb": 3.5,
            },
        ),
        (
            "V22-hb7+novol",
            {"v22_fast_exit_vol_confirm": False, "v22_fast_exit_threshold_hb": -0.07},
        ),
        (
            "V22-hb8+novol",
            {"v22_fast_exit_vol_confirm": False, "v22_fast_exit_threshold_hb": -0.08},
        ),
        (
            "V22-hb7+std6+novol",
            {
                "v22_fast_exit_vol_confirm": False,
                "v22_fast_exit_threshold_hb": -0.07,
                "v22_fast_exit_threshold_std": -0.06,
            },
        ),
    ...
    print(
        f"  {'ref':>4} {'V19.1':<30} {m_v191['total_pnl']:>+9.1f}% {m_v191['pf']:>5.2f} {m_v191['wr']:>5.1f}% "
