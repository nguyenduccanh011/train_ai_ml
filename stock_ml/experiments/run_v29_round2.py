...
def fmt(name, m, cs, base_cs=None):
    ...
    return (
        f"  {name:<40} | {m['trades']:>5} {m['wr']:>5.1f}% {m['avg_pnl']:>+7.2f}% "
...
if __name__ == "__main__":
    ...
    experiments = [
        ...
        (
            ...
            dict(
                ...
                v29_adaptive_peak_lock_trigger=0.15,
                v29_adaptive_peak_lock_keep=0.45,
            ),
        ),
        (
            "P1e: peak_lock 20%/50%",
            dict(
                v29_adaptive_peak_lock=True,
                v29_adaptive_peak_lock_trigger=0.20,
        ...
        (
            ...
            dict(
                v29_adaptive_peak_lock=True,
                v29_peak_lock_high_beta_only=True,
        ...
        ("P8a: safety net @25%", dict(v29_profit_safety_net=True, v29_profit_safety_trigger=0.25)),
        ("P8b: safety net @20%", dict(v29_profit_safety_net=True, v29_profit_safety_trigger=0.20)),
        ("P8c: safety net @30%", dict(v29_profit_safety_net=True, v29_profit_safety_trigger=0.30)),
        ...
        (
            ...
            dict(
                v29_hardcap_after_peak=True,
                v29_hardcap_after_peak_trigger=0.20,
                v29_hardcap_after_peak_floor=-0.05,
            ),
        ),
        (
            ...
            dict(
                v29_hardcap_after_peak=True,
                v29_hardcap_after_peak_trigger=0.25,
                v29_hardcap_after_peak_floor=-0.03,
            ),
        ),
        # P6 with looser threshold (less aggressive filter)
        ("P6b: relstrength -8%", dict(v29_relstrength_filter=True, v29_rs_ret20_threshold=-0.08)),
        ("P6c: relstrength -10%", dict(v29_relstrength_filter=True, v29_rs_ret20_threshold=-0.10)),
    ]
    ...
    if not pos_sorted:
        ...
        print("  Saved to results/trades_v29_round2_candidate.csv")
