"""
V19.4 Full Upgrade: Exit + Sizing + Symbol Fixes.
===================================================
V19.3 + symbol-specific fixes:
1) VND/SSI: hard stop -15%, MIN_HOLD=4 for non-strong trend
2) ACB: relaxed entry filter (V11 no filter was +59.8% vs V19.1 +26.2%)
3) DGC/AAS: lower dp_floor in strong trend, relax anti-chop when confirmed uptrend
4) Reduced ZOMBIE_BARS for weak trend (14 -> 8)
"""
