...
V19 experimental.
================
Built from V18 with 3 priorities:
1) Entry alpha separated from size policy.
2) Exit quality upgrade for signal exits.
3) Symbol-regime adapter for thresholds and sizing.
"""
...
if __name__ == "__main__":
    ...
    print("=" * 132)
    print(f"V19 COMPARISON (V11/V17/V18/V19 + Rule) - Symbols: {args.pick}")
    print("=" * 132)
    ...
    print("\n" + "=" * 132)
    print("PER-SYMBOL: V11 vs V17 vs V18 vs V19 vs Rule")
    print("=" * 132)
    ...
    b11, b17, b18, b19, br = defaultdict(list), defaultdict(list), defaultdict(list), defaultdict(list), defaultdict(list)
    ...
    print(f"{'Sym':<6}| {'V11 Tot':>9} {'V11 PF':>6} | {'V17 Tot':>9} {'V17 PF':>6} | "
          ...
          f"{'Rule Tot':>9} {'Rule PF':>7} | {'V19-V18':>8} {'V19-Rule':>9}")
    print("-" * 132)
    T11 = T17 = T18 = T19 = TR = 0
    for sym in sorted(set(b11.keys()) | set(b17.keys()) | set(b18.keys()) | set(b19.keys()) | set(br.keys())):
        ...
        T11 += m11["total_pnl"]; T17 += m17["total_pnl"]; T18 += m18["total_pnl"]; T19 += m19["total_pnl"]; TR += mr["total_pnl"]
        print(f"{sym:<6}| {m11['total_pnl']:>+8.1f}% {m11['pf']:>5.2f} | "
              ...
              f"{m19['total_pnl']-m18['total_pnl']:>+7.1f}% {m19['total_pnl']-mr['total_pnl']:>+8.1f}%")
    print("-" * 132)
    print(f"{'TOT':<6}| {T11:>+8.1f}% {'':>6} | {T17:>+8.1f}% {'':>6} | "
          f"{T18:>+8.1f}% {'':>6} | {T19:>+8.1f}% {'':>6} | {TR:>+8.1f}% {'':>7} | {T19-T18:>+7.1f}% {T19-TR:>+8.1f}%")
