...
def backtest_v26_default(y_pred, returns, df_test, feature_cols, **kwargs):
    ...
    v26_config = dict(
        ...
        v26_relaxed_entry=True,       # B
        v26_skip_choppy=True,         # C
        v26_extended_hold=False,
        v26_strong_rule_ensemble=True, # E
        v26_min_position=False,
        v26_score5_penalty=False,
        v26_hardcap_confirm_strong=False,
    )
    merged = {**v25_patches, **v26_config, **kwargs}
