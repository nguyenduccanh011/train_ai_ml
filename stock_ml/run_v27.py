...
def backtest_v27_default(y_pred, returns, df_test, feature_cols, **kwargs):
    v25_patches = dict(
    ...
    merged = {**v25_patches, **v26_base, **v27_selected, **kwargs}
    return backtest_v26(y_pred, returns, df_test, feature_cols, **merged)
...
if __name__ == "__main__":
    ...
    from run_v26 import backtest_v26_default
    ...
    t_v26 = run_test_base(SYMBOLS, True, True, False, False, True, True, True, True, True, True,
                          backtest_fn=backtest_v26_default)
    ...
    t_v27 = run_test_base(SYMBOLS, True, True, False, False, True, True, True, True, True, True,
                          backtest_fn=backtest_v27_default)
    dt = time.time() - t0
