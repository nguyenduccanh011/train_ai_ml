...
VARIANTS = [
    ...
    ("eh_bottom1", {"entry_ensemble": {"type": "bottom_structure_entry_regression", "horizon": 10, "park_window": 20}}),
    ("eh_multih2", {"entry_ensemble2": {"type": "multi_horizon_return", "horizons": [5, 10, 20]}}),
    ("eh_add5dl",  {"entry_ensemble5": {"type": "downleg_depth_regression", "max_span": 40}}),  # NEW 5th head
]
