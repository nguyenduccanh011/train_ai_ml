...
VARIANTS = {
    "e5_ampdir_z09": {"target": {"type": "amplitude_direction_entry", "horizon": 20}, "z_threshold": 0.9},
    "e5_ampdir_z11": {"target": {"type": "amplitude_direction_entry", "horizon": 20}, "z_threshold": 1.1},
    "e5_csent_z09":  {"target": {"type": "cross_sectional_entry", "horizon": 10}, "z_threshold": 0.9},
}
...
async def make_all():
    ...
    async with Session() as s:
        ...
        for nm, ens5 in VARIANTS.items():
            ...
            be = copy.deepcopy(be0); be["entry_ensemble5"] = ens5
