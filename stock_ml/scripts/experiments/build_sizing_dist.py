"""FAIR conviction-sizing with the RIGHT signal: size by dist20low (IC +0.189 vs per-trade pnl, 2x
...
con.close()
print("\n=== SIZE by dist20low (select by score), fair mean-1 — vs equal, sign 3/3 @matched exposure ===")
