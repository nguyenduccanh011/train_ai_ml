...
BASE_TMPL = 2459
SEEDS = [42, 7, 99]
BASE_TARGET = {"type": "action_oracle", "pct": 0.10, "min_fwd_leg": 0.10,
               "min_leg_bars": 3, "entry_min_ret_120": -0.10}
...
def main():
    for new_name, confirm in SWEEP.items():
        ...
        if comps:
            ...
            print(f"== {new_name} (confirm={confirm}): MEAN={mean:.1f} std={std:.1f} seeds={seeds}\n")
    print("== vs v5_reg10 -46.7 (pnl+21.5 pf1.53 mdd0.341 WR0.69) ; baselines 197.4/397.8 ; champ 704")
