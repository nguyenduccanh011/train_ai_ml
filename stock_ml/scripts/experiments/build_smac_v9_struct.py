...
ENTRY_TARGET = {"type": "action_oracle", "pct": 0.10, "min_fwd_leg": 0.10,
                "min_leg_bars": 3, "entry_min_ret_120": -0.10, "entry_confirm_pct": 0.06}
...
def main():
    ...
    if comps:
        ...
        print("== vs v8 conf06 -33.0 (pnl+22 pf1.58 mdd0.337 WR0.72) / v5 -46.7 ; baselines 197.4/397.8")
