...
JOBS = [
    ("base_xh300_s7", 3064, 7), ("base_xh300_s99", 3064, 99),
    ("rvz07_s7", 3085, 7), ("rvz07_s99", 3085, 99),
]
    ...
    async with Session() as s:
        ...
        for new_name, base_id, seed in JOBS:
            ...
            t = await repo.create(
                ...
                hypothesis="seed-robustness of rv_z07 vs base", universe_slug=base.universe_slug,
