"""Multi-seed confirm x2_struct_to (double-RS + structure-trail trend-only) vs double-RS.
Clone seed-named of x2_struct_to (3185) at 7/99. double-RS mean 65.03 (42/7/99=65.8/64.8/64.5).
x2_struct_to seed42=66.0.
"""
...
JOBS = [("struct_to_s7", 3185, 7), ("struct_to_s99", 3185, 99)]
...
async def make_all():
    ...
    async with Session() as s:
        ...
        for new_name, base_id, seed in JOBS:
            ...
            if ex:
                print(f"exists {new_name} id={ex.id}"); ids[new_name] = (ex.id, seed); continue
            ...
            t = await repo.create(
                ...
                description=f"multiseed struct-trail clone seed {seed}", hypothesis="seed-robustness of structure-trail on RS",
