"""Multi-seed confirm xr_liq (RS + cross-sectional liquidity+vol ranks) vs double-RS. Clone seed-named
of xr_liq (3168) at 7/99. double-RS: 42/7/99=65.8/64.8/64.5 (mean 65.03). xr_liq seed42=66.0.
"""
...
JOBS = [("xrliq_s7", 3168, 7), ("xrliq_s99", 3168, 99)]
    ...
    async with Session() as s:
        ...
        for new_name, base_id, seed in JOBS:
            ...
            t = await repo.create(
                ...
                description=f"multiseed xr_liq clone seed {seed}", hypothesis="seed-robustness of RS+liq/vol ranks",
