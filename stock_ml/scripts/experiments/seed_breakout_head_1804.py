...
GRID = [
    ("brk_p10", {"type": "continuation_entry_regression", "horizon": 10, "penalty": 1.0, "trend_window": 50}),
    ("brk_p05", {"type": "continuation_entry_regression", "horizon": 10, "penalty": 0.5, "trend_window": 50}),
]
