...
def s_ma50(e):
    e["exit_force_suppress"] = "abovema50"


def s_ma50r40(e):
    e["exit_force_suppress"] = "abovema50_rsi40"


def s_ma30(e):
    e["exit_force_suppress"] = "abovema30"


def s_rsi45(e):
    e["exit_force_suppress"] = "rsi45"


def s_mabrk(e):
    e["exit_force_gate"] = "downleg12_mabreak20p3m50"  # config-only control
