...
GRID = [
    ...
    ("n2_gb_div08_th30", {"overext_pct": 0.08, "overext_reversal_mode": "bear_div", "overext_div_threshold": 0.30}),
    ("n2_gb_div08_th50", {"overext_pct": 0.08, "overext_reversal_mode": "bear_div", "overext_div_threshold": 0.50}),
    ("n2_gb_div10_th30", {"overext_pct": 0.10, "overext_reversal_mode": "bear_div", "overext_div_threshold": 0.30}),
    ("n2_gb_sdn08", {"overext_pct": 0.08, "overext_reversal_mode": "strong_down", "overext_strong_down_pct": 0.02}),
    # conditional + arm a trail instead of hard sell (ride if it recovers)
    ("n2_gb_div08_trail05", {"overext_pct": 0.08, "overext_reversal_mode": "bear_div", "overext_div_threshold": 0.30, "overext_trail_pct": 0.05}),
    # composing: let per-symbol uptrend runners run (PnL+) AND protect flat-zone faders
    ("n2_gb_slope03_act08", {"overext_skip_ma_slope_pct": 0.03, "overext_skip_lookback": 5, "trailing_activate_pct": 0.08}),
    ("n2_gb_slope03_bull", {"overext_skip_ma_slope_pct": 0.03, "overext_skip_lookback": 5, "overext_skip_bull_enabled": True, "overext_bull_threshold": 1.0}),
