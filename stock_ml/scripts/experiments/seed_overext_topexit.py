...
GRID = [
    ...
    ("n2_1204_ox20_12",  _ox(0.12, False), "overext ma20 pct0.12 no-reversal (sell every extended bar)"),
    ("n2_1204_topx_n3r15", _topx(0.03, 0.15, 2), "reuse top_reversal_exit near0.03 run0.15 confirms2"),
]
    ...
    async with Session() as session:
        ...
        slots_def = [
            {"slot_type": "entry", "ml_component_id": entry_slot.ml_component_id,
             "rule_component_id": None, "feature_set_name": entry_slot.feature_set_name,
             "target_config": _tc(entry_slot)},
            {"slot_type": "exit", "ml_component_id": exit_slot.ml_component_id,
             "rule_component_id": None, "feature_set_name": exit_slot.feature_set_name,
