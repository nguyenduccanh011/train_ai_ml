...
def _pb(e, pct=0.03, win=25):
    e["entry_pullback_pct"] = pct
    e["entry_pullback_window"] = win
...
# isolation
def m_pb(e):
    _pb(e)  # pullback only, hold 20, signal exit


def m_pb_h250(e):
    _pb(e)
    _hold(e, 250)  # pullback only + lift cap
