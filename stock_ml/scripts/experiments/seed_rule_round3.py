...
def _winner(e):
    e["entry_pullback_pct"] = 0.03
    e["entry_pullback_window"] = 25
    e["trailing_stop_pct"] = 0.08
    e["trailing_activate_pct"] = 0.15
    e["trailing_atr_mult"] = 2.0
    e["overext_ma_window"] = 20
    e["overext_pct"] = 0.14
    e["overext_reversal"] = False
    e["max_hold_bars"] = 250
...
def m_hs08(e):
    _winner(e)
    e["hard_stop_pct"] = -0.08
    e["exit_priority"] = ["hard_stop", "trailing_stop", "overext", "signal"]


def m_hs06(e):
    _winner(e)
    e["hard_stop_pct"] = -0.06
    e["exit_priority"] = ["hard_stop", "trailing_stop", "overext", "signal"]


def m_hs10(e):
    _winner(e)
    e["hard_stop_pct"] = -0.10
    e["exit_priority"] = ["hard_stop", "trailing_stop", "overext", "signal"]


def m_nosig(e):
    _winner(e)
    e["exit_priority"] = ["trailing_stop", "overext"]


def m_hs08_nosig(e):
    _winner(e)
    e["hard_stop_pct"] = -0.08
    e["exit_priority"] = ["hard_stop", "trailing_stop", "overext"]
