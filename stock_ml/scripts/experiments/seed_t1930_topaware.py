"""Clone champion 1930, swap ONLY the entry slot feature_set to entry_lvup126_topaware
(= recov + upper_wick_5 + lower_high_20, the top_struct_probe structural-TOP signals). Goal: an entry
head that natively down-scores du-dinh / right-shoulder entries instead of a post-hoc gate. Eval after
