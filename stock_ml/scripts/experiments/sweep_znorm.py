...
BASE_TMPL = 2646
CHAMP = dict(
    comp=729.6, pnl=127.25301810134556, pf=5.963310002880663, mdd=0.17454927579356125, tr=1384
)
...
def main():
    ...
    for sd in seeds:
        ...
        print(
            f"RESULT {name} tmpl={new_id} seed={sd} comp={comp} d={comp - CHAMP['comp']:+.1f} "
            f"pnl={pnl:.3f} pf={pf:.3f} mdd={mdd:.4f} tr={tr}",
            flush=True,
        )
