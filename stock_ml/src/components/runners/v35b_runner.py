...
def _build_prediction_cache(
    ...
    *,
    ...
    model_cfg = get_model_config("v35b")
...
def _backtest_v35b(
    ...
    **kwargs: Any,
    ...
    from experiments.run_v34_final import backtest_v35b

    return backtest_v35b(y_pred, returns, df_test, feature_cols, **kwargs)


def trades_to_v35b_dataframe(trades: list[Trade | dict[str, Any]]) -> pd.DataFrame:
