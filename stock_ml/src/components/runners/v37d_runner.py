...
def _backtest_v37d(
    ...
    **kwargs: Any,
    ...
    from experiments.run_v37d import backtest_v37d

    return backtest_v37d(y_pred, returns, df_test, feature_cols, **kwargs)


def trades_to_v37d_dataframe(trades: list[Trade | dict[str, Any]]) -> pd.DataFrame:
