...
def _build_prediction_cache(
    ...
    *,
    ...
    model_cfg = get_model_config("v39d")
...
def _backtest_v39d(
    ...
    **kwargs: Any,
    ...
    from experiments.run_v39d import backtest_v39d

    return backtest_v39d(y_pred, returns, df_test, feature_cols, **kwargs)


def trades_to_v39d_dataframe(trades: list[Trade | dict[str, Any]]) -> pd.DataFrame:
