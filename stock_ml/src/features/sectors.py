...
SECTOR_MAP: dict[str, str] = {
    # Finance / Ngân hàng
    "ACB": "Finance", "BID": "Finance", "CTG": "Finance", "MBB": "Finance",
    "TCB": "Finance", "VIB": "Finance", "VCB": "Finance", "SHB": "Finance",
    "STB": "Finance", "HDB": "Finance", "TPB": "Finance", "EIB": "Finance",
    "OCB": "Finance", "SGB": "Finance", "VPB": "Finance", "MSB": "Finance",
    "NVB": "Finance", "NAB": "Finance", "KLB": "Finance", "KBC": "Finance",
    "DBC": "Finance", "SEA": "Finance", "BAF": "Finance", "BFC": "Finance",
    "BSI": "Finance",
    # Consumer / Tiêu dùng
    "VNM": "Consumer", "SAB": "Consumer", "BHN": "Consumer", "MSN": "Consumer",
    "MWG": "Consumer", "CII": "Consumer", "DGW": "Consumer", "PNJ": "Consumer",
    "LGC": "Consumer",
    # Energy / Năng lượng
    "GAS": "Energy", "PVD": "Energy", "PVH": "Energy", "BSR": "Energy",
    "POW": "Energy", "NT2": "Energy", "QTP": "Energy", "PVB": "Energy",
    # Materials / Vật liệu
    "HPG": "Materials", "NKG": "Materials", "DGC": "Materials", "HSG": "Materials",
    "TAC": "Materials", "THD": "Materials", "CVN": "Materials", "DRC": "Materials",
    "PAS": "Materials", "REE": "Materials", "RAL": "Materials", "NLG": "Materials",
    "ROS": "Materials",
    # Industrials / Công nghiệp
    "VJC": "Industrials", "ACV": "Industrials", "HAH": "Industrials", "HND": "Industrials",
    "VSC": "Industrials", "GMD": "Industrials", "ITA": "Industrials",
    # Technology / Công nghệ
    "FPT": "Technology", "CMG": "Technology", "ICT": "Technology", "VGI": "Technology",
    "HUT": "Technology", "ITC": "Technology", "BBS": "Technology",
    # Real Estate / Bất động sản
    "VHM": "RealEstate", "NVL": "RealEstate", "DXG": "RealEstate", "VRE": "RealEstate",
    "HCM": "RealEstate", "KDH": "RealEstate", "PDR": "RealEstate", "LDG": "RealEstate",
    "SCR": "RealEstate", "DIG": "RealEstate",
}
