...
from stock_ml.src.backtest.engine import EngineConfig
...
class LiveSimConfig:
    ...
    # Exit policy is REQUIRED — no silent default engine. Mirrors EngineConfig,
    # which no longer defaults max_hold_bars / hard_stop_pct.
    engine: EngineConfig
