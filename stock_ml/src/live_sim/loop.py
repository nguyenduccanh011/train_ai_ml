...
from stock_ml.src.live_sim.executor import EntryExecutor, ExitEvaluator
from stock_ml.src.live_sim.reporter import Reporter
from stock_ml.src.live_sim.signals import SignalGenerator
from stock_ml.src.live_sim.state import ClosedTrade, SimState
...
class LiveSimEngine:
    ...
    def run(self) -> dict:
        ...
        full_feat = add_features(full_ohlcv, "basic_v1")
