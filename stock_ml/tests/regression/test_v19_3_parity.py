"""Regression: componentized v19_3 runner should match golden trades_v19_3.csv."""
...
GOLDEN_CSV = GOLDEN_DIR / "trades_v19_3.csv"
GOLDEN_META = GOLDEN_DIR / "trades_v19_3.meta.json"


@pytest.mark.regression
def test_v19_3_matches_golden() -> None:
    ...
    df_raw = trades_to_v19_3_dataframe(trades).reset_index(drop=True)
    ...
    # Pandas reads empty max_profit_pct for open-end trades as NaN; normalize None similarly.
