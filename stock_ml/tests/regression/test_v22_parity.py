"""Regression: componentized v22 runner should match golden trades_v22.csv."""
...
def test_v22_matches_golden() -> None:
    from src.components.runners import run_v22, trades_to_v22_dataframe
