"""Regression: componentized v34 runner should match golden trades_v34.csv."""
...
GOLDEN_CSV = GOLDEN_DIR / "trades_v34.csv"
GOLDEN_META = GOLDEN_DIR / "trades_v34.meta.json"


@pytest.mark.regression
def test_v34_matches_golden() -> None:
    from src.components.runners import run_v34, trades_to_v34_dataframe
    ...
    exit_model_cfg = model_cfg.get("exit_model") or None
    ...
    df_raw = trades_to_v34_dataframe(trades).reset_index(drop=True)
