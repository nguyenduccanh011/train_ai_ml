"""Regression: componentized v37a runner should match golden trades_v37a.csv."""
...
GOLDEN_CSV = GOLDEN_DIR / "trades_v37a.csv"
GOLDEN_META = GOLDEN_DIR / "trades_v37a.meta.json"


@pytest.mark.regression
def test_v37a_matches_golden() -> None:
    from src.components.runners import run_v37a, trades_to_v37a_dataframe
    ...
    df_raw = trades_to_v37a_dataframe(trades).reset_index(drop=True)
