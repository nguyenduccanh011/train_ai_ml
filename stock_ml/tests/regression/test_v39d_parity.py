"""Regression: componentized v39d runner should match golden trades_v39d.csv."""
...
GOLDEN_CSV = GOLDEN_DIR / "trades_v39d.csv"
GOLDEN_META = GOLDEN_DIR / "trades_v39d.meta.json"


@pytest.mark.regression
def test_v39d_matches_golden() -> None:
    from src.components.runners import run_v39d, trades_to_v39d_dataframe
    ...
    df_raw = trades_to_v39d_dataframe(trades).reset_index(drop=True)
