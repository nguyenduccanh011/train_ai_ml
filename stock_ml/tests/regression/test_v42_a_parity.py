"""Regression: componentized v42_a runner should match golden trades_v42_a.csv."""
...
GOLDEN_CSV = GOLDEN_DIR / "trades_v42_a.csv"
GOLDEN_META = GOLDEN_DIR / "trades_v42_a.meta.json"


@pytest.mark.regression
def test_v42_a_matches_golden() -> None:
    from src.components.runners import run_v42_a, trades_to_v42_a_dataframe
    ...
    df_raw = trades_to_v42_a_dataframe(trades).reset_index(drop=True)
