        ...
        try:
            for symbol in symbols:
                try:
                    ...
                    print(f"{symbol}: inserted={inserted} updated={updated} invalid_skipped={invalid}")
            ...
            finish_ingestion_run(conn, run_id, "success" if totals["errors"] == 0 else "partial", totals)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--symbols", default=str(DEFAULT_SYMBOLS), help="JSON/TXT file or comma-separated symbols")
