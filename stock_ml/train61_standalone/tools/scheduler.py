...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--latest-limit", type=int, default=int(os.getenv("SIEUTINHIEU_LATEST_LIMIT", "10")))
    parser.add_argument("--interval-seconds", type=int, default=int(os.getenv("SCHEDULER_INTERVAL_SECONDS", "86400")))
